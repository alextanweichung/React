    ...
    <section id="contactus" className="mx-auto w-5/6 pt-24 pb-32">
        ...
        >
            ...
            >
                ...
                <p className="my-5">
                    Congue adipiscing risus commodo placerat. Tellus et in feugiat nisl sapien vel rhoncus. Placerat at in enim peillentesque. Nulla adipiscing leo egestas nisi elit risus sit. Nunc cursus sagttis.
                </p>
            </motion.div>
            ...
            <div className="mt-10 justify-between gap-8 md:flex">
                ...
                >
                    <form
                        target="_blank"
                        onSubmit={onSubmit}
                        action="https://formsubmit.co/el/vipeso"
                        method="POST"
                    >
                        <input
